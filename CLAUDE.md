...
This project is indexed by GitNexus as **ndm** (1505 symbols, 2500 relationships, 77 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
