...
This project is indexed by GitNexus as **ndm** (6555 symbols, 11658 relationships, 255 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
