...
This project is indexed by GitNexus as **ndm** (2113 symbols, 3391 relationships, 92 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
