...
This project is indexed by GitNexus as **ndm** (1178 symbols, 2015 relationships, 68 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
