...
This project is indexed by GitNexus as **ndm** (3274 symbols, 5270 relationships, 137 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
