...
<p align="center">
  <img src="https://img.shields.io/badge/Version-2.9.19-2DD46E" alt="Version 2.9.19">
...
- **自定义报告** — 三张大表（软件版本 / 设备在线时间 / 带宽利用率），统一支持**按位置过滤 + 点列头排序 + 导出 CSV**（带 UTF-8 BOM，Excel 直接打开）。软件版本报告按**物理成员**展开（SZXD1SWI01-1/-2/-3），逐台显示序列号、型号、版本、ROM 版本与运行时间，堆叠内成员版本不一致时点名告警（升级未完成的信号）
